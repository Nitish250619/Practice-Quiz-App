...
import { dsaStringQuestions } from "../../../data/DsaData/stringQuestion.js";
import {
  Box,
  Card,
  CardContent,
...
const DsaString = () => {
  ...
  const uniqueDays = useMemo(
    () =>
      Array.from(new Set(dsaStringQuestions.map((q) => q.day))).sort(
        (a, b) => a - b
      ),
    []
  );
  ...
  const uniqueDifficulties = useMemo(
    () => Array.from(new Set(dsaStringQuestions.map((q) => q.difficulty))),
    []
  );

  const filteredQuestions = useMemo(() => {
    return dsaStringQuestions.filter((q) => {
    ...
    >
      ...
      >
        ...
        <Box textAlign="center" mb={3}>
          ...
          >
            🔤 DSA Strings — MAANG-Level Questions
          </Typography>
          <Typography
            variant="subtitle1"
            ...
            sx={{ mt: 1 }}
          >
            Master substrings, sliding window, anagrams, palindromes & more.
          </Typography>
        </Box>
